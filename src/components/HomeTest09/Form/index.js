                ...
                <div className="modal-content">
                    ...
                    <div className="modal-body">
                        <div className="mb-3">
                            ...
                            <input type="text" id="form-name" name="name" class='form-control' placeholder="Nguyen Van A" onChange={onChange}></input>
                        </div>
                        <div className="mb-3">
                            <label for='form-name' className="form-label">Email</label>
                            <input type="email" id="form-email" name="email" class='form-control' placeholder="name@example.com" onChange={onChange}></input>
                        </div>
                        
                    </div>
                    <div className="modal-footer">
                        <button className="btn btn-secondary" data-bs-dismiss='modal'>Cancel</button>
                        <button className="btn btn-primary" disabled={disabled} onClick={onSubmit} data-bs-dismiss='modal'>Submit</button>
                    </div>
                </div>
            </div>
        </div>
